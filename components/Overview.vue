...
<li><kbd>Node</kbd> objects wrap <carbon-logo-python class="inline text-yellow-500"/> functions</li>
<li><kbd>Pipelines</kbd> string together <kbd>Node</kbd> objects</li>
<li>Python <carbon-logo-python class="inline text-yellow-500"/> and CLI  <carbon-terminal class="inline text-yellow-500"/> API</li>
